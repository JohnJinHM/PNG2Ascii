...
int main(){
    ...
    // unsigned char *bitmap = font8x8_basic['X'];
    ...
    cin >> xtoken_cnt;
    cout << "Enter expected output height (Enter 0 to keep aspect ratio): " << endl;
    cin >> ytoken_cnt;
    ...
    switch (mode){
        case 0:
            if(ytoken_cnt == 0){
                ytoken_cnt = (double)(img_x/img_y)*xtoken_cnt/2.5; // Magic number, depend on dimensions of the font
            }
        ...
        case 1:
            if(ytoken_cnt == 0){
                ytoken_cnt = (double)(img_x/img_y)*xtoken_cnt/2.5;
            }
